...
class AccountServiceTest {
    ...
    void testXXX() {
        ...
        // when
        Account account = accountService.getAccount(4555L); // findById호출

        // then
        verify(accountRepository, times(1)).findById(captor.capture());
        verify(accountRepository, times(0)).save(any()); // save를 호출안했으므로 0
