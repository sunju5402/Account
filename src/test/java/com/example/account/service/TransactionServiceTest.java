...
class TransactionServiceTest {
    public static final long USE_AMOUNT = 2300L;
    public static final long CANCEL_AMOUNT = 2300L;
    @Mock
    ...
    void successUseBalance() {
        ...
        assertEquals(7700L, captor.getValue().getBalanceSnapshot());
    ...
    void cancelTrasaction_AccountNotFound() {
        // given
        given(transactionRepository.findByTransactionId(anyString()))
    ...
    @Test
    @DisplayName("거래와 계자가 매칭 실패 - 잔액 사용 취소 실패")
    void cancelTrasaction_TransactionAccountUnMatch() {
        // given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
    ...
    void cancelTrasaction_CancelMustFully() {
        // given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
    ...
    void cancelTrasaction_TooOldOrder() {
        // given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
